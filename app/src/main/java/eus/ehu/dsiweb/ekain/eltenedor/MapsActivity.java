...
public class MapsActivity extends FragmentActivity {
    ...
    private void setUpMap() {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(longitude, latitude)).title("Marker"));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(longitude, latitude), 14.0f));
